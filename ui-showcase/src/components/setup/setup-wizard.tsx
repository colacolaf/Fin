            ...
            >
              ...
              <AnimatePresence>
                {isSelected && (
                  ...
                  >
                    <div className="border-t border-white/[0.04] px-3.5 py-3 space-y-2">
          ...
          return (
            ...
            >
              <div className={cn(
                ...
                isActive ? "bg-[#818CF8]/15 text-[#818CF8]" : "bg-white/[0.04] text-white/[0.40]"
              )}>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {isActive && <Check className="h-3.5 w-3.5 text-[#818CF8]" />}
                </div>
...
function DoneStep() {
  const checkItems = [
    { label: "Authorization key set", done: true },
    { label: "Encryption key set", done: true },
    { label: "Accounts connected", done: true },
    { label: "AI model selected", done: true },
  ]
      ...
      <div className="space-y-2">
        {checkItems.map((item) => (
          <div key={item.label} className="flex items-center gap-2.5 rounded-lg border border-white/[0.04] bg-white/[0.02] px-3 py-2.5">
            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[#34D399]/15 text-[#34D399]">
              <Check className="h-3 w-3" />
            </div>
            <span className="text-[12px] text-white/[0.65]">{item.label}</span>
          </div>
        ))}
      </div>
    </div>
