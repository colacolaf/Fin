...
export default function LoadingScreen({
  ...
  useEffect(() => {
    ...
    const animate = (now: number) => {
      ...
      setMessageIndex(
        Math.min(
          Math.floor((nextProgress / 100) * loadingMessages.length),
  ...
  return (
    <div
      className={cn(
        "relative z-0 flex h-full w-full flex-col overflow-hidden rounded-2xl bg-black text-white",
        className
      )}
    >
