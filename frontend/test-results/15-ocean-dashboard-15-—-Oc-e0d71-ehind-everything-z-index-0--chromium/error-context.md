...
- Name: 15-ocean-dashboard.spec.ts >> 15 — Ocean Dashboard Pass >> 15.3 — Ocean canvas is visible behind everything (z-index 0)
- Location: e2e/specs/15-ocean-dashboard.spec.ts:78:3
