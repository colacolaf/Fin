...
- Name: 15-ocean-dashboard.spec.ts >> 15 — Ocean Dashboard Pass >> 15.5 — Click fin opens Agent Context View (submarine cabin)
- Location: e2e/specs/15-ocean-dashboard.spec.ts:93:3
