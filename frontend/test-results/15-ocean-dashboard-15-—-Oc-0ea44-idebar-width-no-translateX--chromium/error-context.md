...
- Name: 15-ocean-dashboard.spec.ts >> 15 — Ocean Dashboard Pass >> 15.2 — Hamburger toggles sidebar width (no translateX)
- Location: e2e/specs/15-ocean-dashboard.spec.ts:63:3
