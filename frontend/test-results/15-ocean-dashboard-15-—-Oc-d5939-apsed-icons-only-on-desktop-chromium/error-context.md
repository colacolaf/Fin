...
- Name: 15-ocean-dashboard.spec.ts >> 15 — Ocean Dashboard Pass >> 15.1 — Sidebar starts collapsed (icons only) on desktop
- Location: e2e/specs/15-ocean-dashboard.spec.ts:35:3
