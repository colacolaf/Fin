...
- Name: retirement.spec.ts >> Retirement Dashboard >> renders retirement page with profile inputs
- Location: e2e/retirement.spec.ts:9:3
...
Locator: locator('h1')
Expected substring: "Retirement Analysis"
