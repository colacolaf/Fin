...
- Name: 06-retirement.spec.ts >> 06 — Retirement Dashboard >> On-track indicator present
- Location: e2e/specs/06-retirement.spec.ts:36:3
...
Call log:
  ...
  - waiting for getByText(/on track/i)
