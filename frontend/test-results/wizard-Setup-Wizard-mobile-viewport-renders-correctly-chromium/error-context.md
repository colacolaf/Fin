...
- Name: wizard.spec.ts >> Setup Wizard >> mobile viewport renders correctly
- Location: e2e/wizard.spec.ts:169:3
...
Locator: locator('[data-testid="setup-wizard"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="setup-wizard"]')
