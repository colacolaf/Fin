...
- Name: retirement.spec.ts >> Retirement Dashboard >> renders score gauge after load
- Location: e2e/retirement.spec.ts:17:3
...
Call log:
  - waiting for locator('.retirement-score, .loading-skeleton, .alert') to be visible
