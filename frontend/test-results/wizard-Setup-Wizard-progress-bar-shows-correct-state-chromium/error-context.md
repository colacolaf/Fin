...
- Name: wizard.spec.ts >> Setup Wizard >> progress bar shows correct state
- Location: e2e/wizard.spec.ts:71:3
...
Locator: locator('[data-step="0"]')
Expected pattern: /wizard-progress__dot--active/
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveClass" with timeout 5000ms
  - waiting for locator('[data-step="0"]')
