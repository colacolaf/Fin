...
- Name: retirement.spec.ts >> Retirement Dashboard >> renders tax strategy section
- Location: e2e/retirement.spec.ts:68:3
...
Call log:
  - waiting for locator('.tax-strategy') to be visible
