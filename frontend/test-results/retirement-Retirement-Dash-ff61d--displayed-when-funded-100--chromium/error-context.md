...
- Name: retirement.spec.ts >> Retirement Dashboard >> shortfall displayed when funded < 100%
- Location: e2e/retirement.spec.ts:95:3
...
Call log:
  - waiting for locator('.input-grid input').nth(2)
