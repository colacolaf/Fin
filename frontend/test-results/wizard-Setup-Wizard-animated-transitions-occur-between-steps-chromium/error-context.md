...
- Name: wizard.spec.ts >> Setup Wizard >> animated transitions occur between steps
- Location: e2e/wizard.spec.ts:120:3
...
Locator: locator('text=Connect Broker')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Connect Broker')
