...
- Name: retirement.spec.ts >> Retirement Dashboard >> refresh button triggers reload
- Location: e2e/retirement.spec.ts:78:3
...
Locator: locator('.retirement-header button')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.retirement-header button')
