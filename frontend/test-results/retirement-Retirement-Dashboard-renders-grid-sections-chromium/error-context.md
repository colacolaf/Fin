...
- Name: retirement.spec.ts >> Retirement Dashboard >> renders grid sections
- Location: e2e/retirement.spec.ts:55:3
...
Call log:
  - waiting for locator('.retirement-grid') to be visible
