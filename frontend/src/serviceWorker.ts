/**
 * serviceWorker.ts — Workbox-powered service worker.
 ...
 *
 * Requires: npm install workbox-precaching workbox-routing workbox-strategies workbox-expiration workbox-background-sync
 */
...
// ---- 1. Precache static assets (injected by vite-plugin-pwa or build tool) ----
...
setCatchHandler(async ({ request }) => {
  if (request.destination === "document") {
    // Return the app shell, which shows the offline UI
